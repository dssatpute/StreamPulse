...
@dp.create_view(
    name="content_catalog_dim_clean"
)
def content_catalog_dim_clean():
    return spark.readStream.table("streampulse.bronze.content_catalog_dim").select("title","cast","content_id","content_type","director","duration_min","episode_number","genre","language","maturity_rating","release_year","season_number","updated_at")
